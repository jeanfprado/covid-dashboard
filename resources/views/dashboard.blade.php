...
<div class="row" style="margin-top:30px">
    <div class="col-3">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div style="overflow: auto; height: 1425px">
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th scope="row"><a class="url-state" href="?state={{$state->uf}}">{{$state->state}}</a>
                                </th>
                                <td>{{$state->deaths}}</td>
                            </tr>
                            @endforeach
    ...
    <div class="col-6">
        <div class="col-sm-12">
            <h4 style="text-align: center">Resultados @if(Request::has('state')){{Request::query('state')}} @else Brasil
                @endif</h4>
            <!-- Chart's container -->
            ...
            <h4 style="text-align: center">Resultados Óbitos Registrado em Cartório
                @if(Request::has('state')){{Request::query('state')}} @else Brasil @endif</h4>
            <!-- Chart's container -->
